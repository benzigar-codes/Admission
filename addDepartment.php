...
<body>
    ...
    if (isset($_POST['submit'])) {
        if ($_POST['DepartmentName'] != '' && $_POST['DegreeName'] != '') {
    ...
    <form action="addDepartment.php" method="post" class="from-control m-4 p-4">
        <label for="DName">Enter the <b>Name of the Department</b></label>
        <input type="text" name="DepartmentName" id="DName" class="form-control">
        <hr>
        <p>Note : You should add one degree while creating a Department <br>Later You can add more Degrees,, </p>
        ...
        <input type="submit" name="submit" value="Add Department" class="mt-3 btn btn-primary">
    </form>
</body>
